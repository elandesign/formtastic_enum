...
describe "Formtastic" do
  ...
  it "should have included the ElanDesign::Formtastic::Enum module" do
    Formtastic::SemanticFormBuilder.included_modules.should include(ElanDesign::Formtastic::Enum)
  end
  
  it "should render an :as => :enum field as a select input" do
    semantic_form_for @task do |builder|
      concat(
        builder.inputs(:status) { 
